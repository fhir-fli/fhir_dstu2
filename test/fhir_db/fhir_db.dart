...
Future<void> main() async {
  ...
  group('', () {
    test('Saved A Patient, Found A Patient', () async {
      final List<Resource> search1 = await fhirDb.find(
          resourceType: Dstu2ResourceType.Patient, id: '1', pw: password1);
    ...
    test('Password Changed', () async {
      ...
      //     resourceType: Dstu2ResourceType.Patient, id: '1');
      // expect(true, search3.isEmpty);
      // await fhirDb.closeAllBoxes();
      final List<Resource> search4 = await fhirDb.find(
          resourceType: Dstu2ResourceType.Patient, id: '1', pw: password2);
  ...
  group('Saving Things:', () {
    test('Save Patient', () async {
      const HumanName humanName =
          HumanName(family: <String>['Atreides'], given: <String>['Duke']);
  ...
  group('Finding Things:', () {
    test('Find 1st Patient', () async {
      final List<Resource> search =
          await fhirDb.find(resourceType: Dstu2ResourceType.Patient, id: id);
      const HumanName humanName =
          HumanName(family: <String>['Atreides'], given: <String>['Duke']);
    ...
    test('Find 3rd Observation', () async {
      final List<Resource> search = await fhirDb.find(
          resourceType: Dstu2ResourceType.Observation, id: 'obs3');
    ...
    test('Find All Observations', () async {
      final List<Resource> search = await fhirDb.getActiveResourcesOfType(
        resourceTypes: <Dstu2ResourceType>[Dstu2ResourceType.Observation],
      );
    ...
    test('Find All (non-historical) Resources', () async {
      ...
      patList.retainWhere((Resource resource) =>
          resource.resourceType == Dstu2ResourceType.Patient);
      orgList.retainWhere((Resource resource) =>
          resource.resourceType == Dstu2ResourceType.Organization);
      obsList.retainWhere((Resource resource) =>
          resource.resourceType == Dstu2ResourceType.Observation);
  ...
  group('Deleting Things:', () {
    test('Delete 2nd Observation', () async {
      await fhirDb.delete(
        resourceType: Dstu2ResourceType.Observation,
        id: 'obs2',
      );
  ...
  group('Password - Finding Things:', () {
    test('Find 1st Patient', () async {
      final List<Resource> search = await fhirDb.find(
          resourceType: Dstu2ResourceType.Patient, id: id, pw: password2);
      const HumanName humanName =
          HumanName(family: <String>['Atreides'], given: <String>['Duke']);
  ...
  group('Password - Deleting Things:', () {
    test('Delete 2nd Observation', () async {
      await fhirDb.delete(
          resourceType: Dstu2ResourceType.Observation, id: 'obs2');
  ...
  group('More Complicated Searching', () {
    test('(& Resources)', () async {
      ...
      final StreamSubscription<Resource?> subscription =
          fhirDb.listen(resourceType: Dstu2ResourceType.Observation).listen(
        (Resource? resource) {
